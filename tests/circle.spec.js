...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  it('Verifica se ao receber um raio, a função `circle` retorna um objeto contendo os valores esperados', () => {
    expect(circle('um', 'dois', 'três')).toBeUndefined();
    ...
    // Teste se circle retorna um objeto.2
    // Teste se o objeto retornado possui 3 propriedades.3
    // Teste se a função, quando não recebe nenhum parâmetro, retorna undefined.4
