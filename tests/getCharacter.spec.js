...
describe('9 - Implemente os casos de teste da função `getCharacter`', () => {
  it('Verifica se a função `getCharacter` retorna o objeto do personagem corretamente.', () => {
    ...
    // Teste se a função, quando não recebe nenhum parâmetro, retorna undefined.1
    // Teste se a função retorna o objeto correto para o parâmetro 'Arya',2
    // Teste se a função retorna o objeto correto para o parâmetro 'Brienne',3
    // Teste se a função retorna o objeto correto para o parâmetro 'Melissandre',4
